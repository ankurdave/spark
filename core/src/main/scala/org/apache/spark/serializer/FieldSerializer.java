...
public class FieldSerializer<T> extends com.esotericsoftware.kryo.Serializer<T> implements Comparator<FieldSerializer.CachedField> {
	final Kryo kryo;
	final Class type;
	...
	private final boolean serializeTransient = true;
