...
private[spark]
class DiskShuffleBlockManager(blockManager: BlockManager) extends ShuffleBlockManager with Logging {
   ...
   */
  override def addCompletedMap(block: ShuffleBlockId, numBuckets: Int): Unit = {
