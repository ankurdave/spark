...
abstract class RDD[T: ClassTag](
  ...
  @transient private[spark] val fullCreationSite = new Throwable().getStackTrace.mkString("\n")
  private[spark] def getCreationSite: String = fullCreationSite // creationSiteInfo.toString
